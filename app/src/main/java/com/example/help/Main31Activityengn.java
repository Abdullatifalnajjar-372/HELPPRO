...
public class Main31Activityengn extends AppCompatActivity {
...
Uri imageUri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main31_activityengn);
        Uri imageUri ;
        ...
        Button back = findViewById(R.id.prev);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Main31Activityengn.this,Main4Activity.class);
                startActivity(i);
            }
        });
        ...
        Drawer build = new DrawerBuilder()
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier() == 1) {
                            Intent a = new Intent(Main31Activityengn.this, Main4Activity.class);
                            startActivity(a);

                        }

                        if (drawerItem.getIdentifier() == 2) {
                            Intent b = new Intent(Main31Activityengn.this, Main7Activityem.class);
                            startActivity(b);
                        ...
                        if (drawerItem.getIdentifier() == 3) {
                            ...
                            Intent c = new Intent(Main31Activityengn.this, Main10Activitydw.class);
                            startActivity(c);
                        }
                        ...
                        if (drawerItem.getIdentifier() == 8) {
                            ...
                            Intent g = new Intent(Main31Activityengn.this, Main6Activity.class);
                            startActivity(g);
                        }
                        return false;
                ...
                .build();
        final TextView ab = findViewById(R.id.emal19);


        Button sendus = findViewById(R.id.mailthem2);
        ...
        final EditText name = findViewById(R.id.side4);
        final EditText email = findViewById(R.id.side5);
        final EditText phone = findViewById(R.id.side6);
        ...
        ts.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(names.isEmpty() || phones.isEmpty() || emails.isEmpty()) {
                    ...
                    Toast.makeText(Main31Activityengn.this, "يرجى تعبئة البيانات", Toast.LENGTH_SHORT).show();
                }else {
                    Intent i = new Intent(Main31Activityengn.this,Main8Activityem.class);
                    startActivity(i);
                }
                return ;
            }
