...
public class Main32Activityteaching extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main32_activityteaching);
        Uri imageUri ;

        cv = (ImageView) findViewById(R.id.cv2);
        ...
        Button back = findViewById(R.id.prev2);


        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Main32Activityteaching.this,Main4Activity.class);
                startActivity(i);
            }
        });
        ...
        Drawer build = new DrawerBuilder()
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier() == 1) {
                            Intent a = new Intent(Main32Activityteaching.this, Main4Activity.class);
                            startActivity(a);

                        }

                        if (drawerItem.getIdentifier() == 2) {
                            Intent b = new Intent(Main32Activityteaching.this, Main7Activityem.class);
                            startActivity(b);
                        ...
                        if (drawerItem.getIdentifier() == 3) {
                            ...
                            Intent c = new Intent(Main32Activityteaching.this, Main10Activitydw.class);
                            startActivity(c);
                        }
                        ...
                        if (drawerItem.getIdentifier() == 8) {
                            ...
                            Intent g = new Intent(Main32Activityteaching.this, Main6Activity.class);
                            startActivity(g);
                        }
                        return false;
                ...
                .build();
        final TextView ab = findViewById(R.id.emal20);


        Button sendus = findViewById(R.id.mailthem3);
        ...
        Button ts = findViewById(R.id.ts2);
        final EditText name = findViewById(R.id.side9);
        final EditText email = findViewById(R.id.side7);
        final EditText phone = findViewById(R.id.side10);
        ...
        if(names.isEmpty() || phones.isEmpty() || emails.isEmpty()) {
            ...
            Toast.makeText(Main32Activityteaching.this, "يرجى تعبئة البيانات", Toast.LENGTH_SHORT).show();
        }else {
            Intent i = new Intent(Main32Activityteaching.this,Main8Activityem.class);
            startActivity(i);
        }
        return ;
    }
