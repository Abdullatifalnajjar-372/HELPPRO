...
public class Main22Activitybusiness extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main22_activitybusiness);
        Button back = findViewById(R.id.rgoo5);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Main22Activitybusiness.this,Main13Activitydw.class);
                startActivity(i);
            }
        });
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier() == 1) {
                            Intent a = new Intent(Main22Activitybusiness.this, Main4Activity.class);
                            startActivity(a);

                        }

                        if (drawerItem.getIdentifier() == 2) {
                            Intent b = new Intent(Main22Activitybusiness.this, Main7Activityem.class);
                            startActivity(b);
                        ...
                        if (drawerItem.getIdentifier() == 3) {
                            ...
                            Intent c = new Intent(Main22Activitybusiness.this, Main10Activitydw.class);
                            startActivity(c);
                        }
                        ...
                        if (drawerItem.getIdentifier() == 8) {
                            ...
                            Intent g = new Intent(Main22Activitybusiness.this, Main6Activity.class);
                            startActivity(g);
                        }
                        return false;
        ...
        final TextView ab = findViewById(R.id.emal10);


        Button sendus = findViewById(R.id.tsj5);
        ...
        Button rs = findViewById(R.id.instag5);
        rs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent b = new Intent(Intent.ACTION_VIEW, Uri.parse("https://instagram.com/businessinsider?igshid=1u5f9t6vumlsn"));
                startActivity(b);
