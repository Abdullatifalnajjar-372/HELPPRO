...
public class Main35Activityamn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main35_activityamn);

        Uri imageUri ;

        cv = (ImageView) findViewById(R.id.cv5);
        ...
        Button back = findViewById(R.id.prev5);


        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Main35Activityamn.this,Main5Activity.class);
                startActivity(i);
            }
        });
        ...
        Drawer build = new DrawerBuilder()
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier() == 1) {
                            Intent a = new Intent(Main35Activityamn.this, Main4Activity.class);
                            startActivity(a);

                        }

                        if (drawerItem.getIdentifier() == 2) {
                            Intent b = new Intent(Main35Activityamn.this, Main7Activityem.class);
                            startActivity(b);
                        ...
                        if (drawerItem.getIdentifier() == 3) {
                            ...
                            Intent c = new Intent(Main35Activityamn.this, Main10Activitydw.class);
                            startActivity(c);
                        }
                        ...
                        if (drawerItem.getIdentifier() == 8) {
                            ...
                            Intent g = new Intent(Main35Activityamn.this, Main6Activity.class);
                            startActivity(g);
                        }
                        return false;
                ...
                .build();
        final TextView ab = findViewById(R.id.emal22);


        Button sendus = findViewById(R.id.mailthem5);
        ...
        Button ts = findViewById(R.id.ts4);
        final EditText name = findViewById(R.id.side21);
        final EditText email = findViewById(R.id.side19);
        final EditText phone = findViewById(R.id.side22);
        ...
        if(names.isEmpty() || phones.isEmpty() || emails.isEmpty()) {
            ...
            Toast.makeText(Main35Activityamn.this, "يرجى تعبئة البيانات", Toast.LENGTH_SHORT).show();
        }else {
            Intent i = new Intent(Main35Activityamn.this,Main8Activityem.class);
            startActivity(i);
        }
        return ;
    }
