...
public class Main20Activitycamera extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main20_activitycamera);
        Button back = findViewById(R.id.rgoo3);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Main20Activitycamera.this,Main13Activitydw.class);
                startActivity(i);
            }
        });
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier() == 1) {
                            Intent a = new Intent(Main20Activitycamera.this, Main4Activity.class);
                            startActivity(a);

                        }

                        if (drawerItem.getIdentifier() == 2) {
                            Intent b = new Intent(Main20Activitycamera.this, Main7Activityem.class);
                            startActivity(b);
                        ...
                        if (drawerItem.getIdentifier() == 3) {
                            ...
                            Intent c = new Intent(Main20Activitycamera.this, Main10Activitydw.class);
                            startActivity(c);
                        }
                        ...
                        if (drawerItem.getIdentifier() == 8) {
                            ...
                            Intent g = new Intent(Main20Activitycamera.this, Main6Activity.class);
                            startActivity(g);
                        }
                        return false;
        ...
        final TextView ab = findViewById(R.id.emal8);


        Button sendus = findViewById(R.id.tsj3);
        ...
        Button rs = findViewById(R.id.instag3);
        rs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent b = new Intent(Intent.ACTION_VIEW, Uri.parse("https://instagram.com/ash_footage?igshid=1mv6xm9tqvy3v"));
                startActivity(b);
