...
public class Main14Activitybarmej extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main14_activitybarmej);
        Button back = findViewById(R.id.button25);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Main14Activitybarmej.this,Main12Activitydw.class);
                startActivity(i);
            }
        });
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier() == 1) {
                            Intent a = new Intent(Main14Activitybarmej.this, Main4Activity.class);
                            startActivity(a);

                        }

                        if (drawerItem.getIdentifier() == 2) {
                            Intent b = new Intent(Main14Activitybarmej.this, Main7Activityem.class);
                            startActivity(b);
                        ...
                        if (drawerItem.getIdentifier() == 3) {
                            ...
                            Intent c = new Intent(Main14Activitybarmej.this, Main10Activitydw.class);
                            startActivity(c);
                        }
                        ...
                        if (drawerItem.getIdentifier() == 8) {
                            ...
                            Intent g = new Intent(Main14Activitybarmej.this, Main6Activity.class);
                            startActivity(g);
                        }
                        return false;
        ...
        final TextView ab = findViewById(R.id.emal2);


        Button sendus = findViewById(R.id.tskappa4);
        ...
        Button rs = findViewById(R.id.button24);

        rs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent b = new Intent(Intent.ACTION_VIEW, Uri.parse("https://instagram.com/joincoded?igshid=1kw8l1zvufamy"));
                startActivity(b);
            }
        });
    }
