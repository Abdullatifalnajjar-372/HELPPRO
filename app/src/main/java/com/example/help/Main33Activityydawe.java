...
public class Main33Activityydawe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main33_activityydawe);

        Uri imageUri ;

        cv = (ImageView) findViewById(R.id.cv3);
        ...
        Button back = findViewById(R.id.prev3);


        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Main33Activityydawe.this,Main4Activity.class);
                startActivity(i);
            }
        });
        ...
        Drawer build = new DrawerBuilder()
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier() == 1) {
                            Intent a = new Intent(Main33Activityydawe.this, Main4Activity.class);
                            startActivity(a);

                        }

                        if (drawerItem.getIdentifier() == 2) {
                            Intent b = new Intent(Main33Activityydawe.this, Main7Activityem.class);
                            startActivity(b);
                        ...
                        if (drawerItem.getIdentifier() == 3) {
                            ...
                            Intent c = new Intent(Main33Activityydawe.this, Main10Activitydw.class);
                            startActivity(c);
                        }
                        ...
                        if (drawerItem.getIdentifier() == 8) {
                            ...
                            Intent g = new Intent(Main33Activityydawe.this, Main6Activity.class);
                            startActivity(g);
                        }
                        return false;
                ...
                .build();
        final TextView ab = findViewById(R.id.emal21);


        Button sendus = findViewById(R.id.mailthem4);
        ...
        Button ts = findViewById(R.id.ts3);
        final EditText name = findViewById(R.id.side13);
        final EditText email = findViewById(R.id.side11);
        final EditText phone = findViewById(R.id.side14);
        ...
        if(names.isEmpty() || phones.isEmpty() || emails.isEmpty()) {
            ...
            Toast.makeText(Main33Activityydawe.this, "يرجى تعبئة البيانات", Toast.LENGTH_SHORT).show();
        }else {
            Intent i = new Intent(Main33Activityydawe.this,Main8Activityem.class);
            startActivity(i);
        }
        return ;
