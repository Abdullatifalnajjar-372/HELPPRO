...
public class Main36Activitybsn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main36_activitybsn);
        Uri imageUri ;

        cv = (ImageView) findViewById(R.id.cv6);
        ...
        Button back = findViewById(R.id.prev6);


        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Main36Activitybsn.this,Main5Activity.class);
                startActivity(i);
            }
        });
        ...
        Toolbar toolBar = findViewById (R.id.toolbar26);
        ...
        Drawer build = new DrawerBuilder()
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier() == 1) {
                            Intent a = new Intent(Main36Activitybsn.this, Main4Activity.class);
                            startActivity(a);

                        }

                        if (drawerItem.getIdentifier() == 2) {
                            Intent b = new Intent(Main36Activitybsn.this, Main7Activityem.class);
                            startActivity(b);
                        ...
                        if (drawerItem.getIdentifier() == 3) {
                            ...
                            Intent c = new Intent(Main36Activitybsn.this, Main10Activitydw.class);
                            startActivity(c);
                        }
                        ...
                        if (drawerItem.getIdentifier() == 8) {
                            ...
                            Intent g = new Intent(Main36Activitybsn.this, Main6Activity.class);
                            startActivity(g);
                        }
                        return false;
                ...
                .build();
        final TextView ab = findViewById(R.id.emal23);


        Button sendus = findViewById(R.id.mailthem6);
        ...
        Button ts = findViewById(R.id.ts5);
        final EditText name = findViewById(R.id.side25);
        final EditText email = findViewById(R.id.side23);
        final EditText phone = findViewById(R.id.side26);
        ...
        if(names.isEmpty() || phones.isEmpty() || emails.isEmpty()) {
            ...
            Toast.makeText(Main36Activitybsn.this, "يرجى تعبئة البيانات", Toast.LENGTH_SHORT).show();
        }else {
            Intent i = new Intent(Main36Activitybsn.this,Main8Activityem.class);
            startActivity(i);
        }
        return ;
