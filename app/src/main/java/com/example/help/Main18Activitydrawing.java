...
public class Main18Activitydrawing extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main18_activitydrawing);
        Button back = findViewById(R.id.rgoo);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Main18Activitydrawing.this,Main13Activitydw.class);
                startActivity(i);
            }
        });


        final TextView ab = findViewById(R.id.emal6);


        Button sendus = findViewById(R.id.tsj);
        ...
        Button rs = findViewById(R.id.instag);
        rs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent b = new Intent(Intent.ACTION_VIEW, Uri.parse("https://instagram.com/abdullatif_art?igshid=qibgns1qgsws"));
                startActivity(b);
        ...
        Toolbar toolBar = findViewById (R.id.toolbar34);
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier() == 1) {
                            Intent a = new Intent(Main18Activitydrawing.this, Main4Activity.class);
                            startActivity(a);

                        }

                        if (drawerItem.getIdentifier() == 2) {
                            Intent b = new Intent(Main18Activitydrawing.this, Main7Activityem.class);
                            startActivity(b);
                        ...
                        if (drawerItem.getIdentifier() == 3) {
                            ...
                            Intent c = new Intent(Main18Activitydrawing.this, Main10Activitydw.class);
                            startActivity(c);
                        }
                        ...
                        if (drawerItem.getIdentifier() == 8) {
                            ...
                            Intent g = new Intent(Main18Activitydrawing.this, Main6Activity.class);
                            startActivity(g);
                        }
                        return false;
