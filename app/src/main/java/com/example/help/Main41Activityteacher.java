...
public class Main41Activityteacher extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main41_activityteacher);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Main41Activityteacher.this,Main7Activityem.class);
                startActivity(i);
            }
        });
        ...
        Drawer build = new DrawerBuilder()
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier() == 1) {
                            Intent a = new Intent(Main41Activityteacher.this, Main4Activity.class);
                            startActivity(a);

                        }

                        if (drawerItem.getIdentifier() == 2) {
                            Intent b = new Intent(Main41Activityteacher.this, Main7Activityem.class);
                            startActivity(b);
                        ...
                        if (drawerItem.getIdentifier() == 3) {
                            ...
                            Intent c = new Intent(Main41Activityteacher.this, Main10Activitydw.class);
                            startActivity(c);
                        }
                        ...
                        if (drawerItem.getIdentifier() == 8) {
                            ...
                            Intent g = new Intent(Main41Activityteacher.this, Main6Activity.class);
                            startActivity(g);
                        }
                        return false;
                ...
                .build();
        final TextView ab = findViewById(R.id.emal27);


        ImageView sendus = findViewById(R.id.imageView29);
        ...
        ImageView sendu = findViewById(R.id.imageView31);
        sendus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent send = new Intent(Intent.ACTION_VIEW
